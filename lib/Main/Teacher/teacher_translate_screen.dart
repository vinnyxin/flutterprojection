...
class TeacherTranslateScreen extends StatefulWidget {
  const TeacherTranslateScreen({Key? key}) : super(key: key);

  @override
  State<TeacherTranslateScreen> createState() => _TeacherTranslateScreenState();
}

class _TeacherTranslateScreenState extends State<TeacherTranslateScreen> with SingleTickerProviderStateMixin{
        ...
        children: [
                        TabBar(
                          ...
                          indicator: UnderlineTabIndicator(
                            ...
                            tabs: [
                                Container(
                                    width:100, alignment: Alignment.centerLeft, child: Tab(text: '번역', )),
                                Container(
                                  width:100, alignment: Alignment.centerLeft, child: Tab(text: '원본',)),
                            ],
                        ),
                        Expanded(
                            child: TabBarView(
                            ...
                            'этом великолепном городе\n '),
                                ...
                                Center(
                                  child: Text('서울의 아침은 늘 분주하게 시작된다. 도심의 높은 빌딩들 사이로 떠오르는 해와 함께, 도시는 그 활기를 더한다. '
        ...
        child: Stack(
          ...
          children:[
            Positioned(
              ...
              child: SizedBox(
                ...
                child: FloatingActionButton.extended(
                  ...
                  backgroundColor: Color(0xFFA7BBFF),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(10),
                  ),
                  label:
                  Text("번역요청", style: TextStyle(fontSize: 13, color: Colors.white, fontWeight: FontWeight.bold,),
                  ),
                ),
              ),
            ),
            ...
            Positioned(
              bottom: 47,
              right: 2,
              child: Image.asset('images/Translator.png',width: 70, height: 70,),
            ),
          ],
        ),
      ),
